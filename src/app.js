...
import ResultsR from "./components/regression/ResultsR";
...
import ResultsC from "./components/classification/ResultsC";
  ...
  return (
    <ChakraProvider>
      ...
      {response &&
        ...
        selectedTask === "regression" && <ResultsR output={response.result} />}
      {response &&
        response.status === "success" &&
        selectedTask === "classification" && (
